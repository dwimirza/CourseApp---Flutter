...
import 'package:final_project/screens/detail_leadership.dart';
import 'package:final_project/screens/detail_page.dart';
import 'package:flutter/material.dart';

class LeadershipCourseItem extends StatelessWidget {
  final Course course;

  LeadershipCourseItem(this.course);
  @override
        ...
        children: [
          ...
          Positioned(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => DetailLeadershipPage(course)));
              },
              child: Text('Start'),
            ),
          )
